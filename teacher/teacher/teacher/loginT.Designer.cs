namespace teacher
{
    partial class loginT
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 教师端登录页面
            // 
            教师端登录页面.AutoSize = true;
            教师端登录页面.Font = new Font("华文行楷", 22.1999989F, FontStyle.Bold, GraphicsUnit.Point);
            教师端登录页面.Location = new Point(112, 66);
            教师端登录页面.Name = "教师端登录页面";
            教师端登录页面.Size = new Size(283, 39);
            教师端登录页面.TabIndex = 9;
            教师端登录页面.Text = "欢迎登录教师端";
            // 
            // textBox2
            // 
